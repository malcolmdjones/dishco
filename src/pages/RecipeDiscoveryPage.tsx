...
const RecipeDiscoveryPage = () => {
  ...
  useEffect(() => {
    if (recipes.length > 0) {
      ...
      console.log(`Shuffled and filtered ${shuffled.length} recipes for discovery`);
      console.log('Recipe types:', [...new Set(shuffled.map(r => r.type))]);
      console.log('Recipe titles:', shuffled.map(r => r.name));
    }
